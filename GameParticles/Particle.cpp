...
{
	//Removing these doesn't seem to affect the particles draw?????, but doesn't help in decreasing time
	...
	//rotation = rotation + (MatrixScale + rotation_velocity)* time_elapsed * 4.0f;
}
